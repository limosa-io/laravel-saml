...
use ArieTimmerman\Laravel\SAML\Exceptions\InvalidReceivedMessageQueryStringException;
use ArieTimmerman\Laravel\SAML\Exceptions\InvalidRequestException;
...
final class ReceivedData
{
    ...
    public static function fromReceivedProviderData(array $requestParams)
    {
        ...
        //TODO: check via another method. Slows down
    ...
    /**
     * @return string
     * @throws \ArieTimmerman\Laravel\SAML\Exceptions\InvalidRequestException
     */
